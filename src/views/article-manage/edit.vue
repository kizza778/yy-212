<template>
  <div id="main">
    ...
    <div id="edit-box">
      <el-button class="button-margin" size="small" type="primary" @click="save(0)">发布</el-button>
      <el-button class="button-margin" size="small" type="success" @click="save(1)">保存</el-button>
    </div>
    <mavon-editor
      ref="md"
      v-model="content"
    ...
    mdImgUpload(pos,file){
      ...
      uploadImg(newData).then(
        res => {
          ...
          //$img2Url(filename,url) :将md源码中图片文件名替换为url
          console.log(res);
